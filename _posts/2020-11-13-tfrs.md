...
현재 TFRS에는 ScaNN을 지원하며 Retrieval모델과 통합해 tf.serving을 활용한 모델 서빙이 가능합니다. 물론 ScaNN 외에도 소개드린 외부 라이브러리들을 활용할 수 있지만, 이 경우 tf.serving을 활용한 모델 서빙이 어렵습니다. 
